  ...
  <div class="signup-signupFormCard mdl-shadow--8dp">
    ...
    <div class="signup-signupForm">
      ...
      <form action="signupresult.php" method="post">
        ...
        <div>
          <label for="irlnameInput">IRL Name: </label>
          <input type="text" id="irlnameInput" name="irlname" size="50">
        </div>
        <div>
        ...
        <div>
          ...
          <input type="password" id="confirmInput" name="confirm" size="50">
        </div>
        <div>
          <label for="email">Email: </label>
          <input type="email" id="emailInput" name="email" size="50">
        </div>
        <div class="signup-signupFormSubmitButton">
          <input type="submit" value="Sign up for ColorLearn">
        </div>
      </form>
    </div>  
  </div>
