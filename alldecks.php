...
<head>
  ...
  <title>LearnCards - All Decks</title>
...
<?php
  ...
  // form the query
  $query = "SELECT dID, dName, dDesc, dAccess, dLanguage, creator FROM proj_Deck";
  ...
  // display all decks belonging to all users - loop over all of the rows in the returned result, in the
