...
<head>
  <meta charset="utf-8">
  <title>ColorLearn - Sign Up Result</title>
...
<?php
  ...
  $providedIRLname = $_POST["irlname"];
  $providedPassword = $_POST["password"];
  $providedEmail = $_POST["email"];

  // insert registration info into the proj_Users table
  $query = "INSERT INTO proj_Users (username, name, pword, email) VALUES (" .
            "'" . $providedUsername . "', " .
            "'" . $providedIRLname . "', " .
            "'" . $providedPassword . "', " .
            "'" . $providedEmail . "');";
  ...
  echo "<p>Congratulations " . $providedIRLname . ", you are now a registered user.</p>";
  echo "<p>You may now log in through the log in page: <a href='login.php'>Log In</a></p>";
  echo "<br><br>";
